                ...
                <div class="col-md-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="raisonSociale" name="raisonSociale" 
                               data-validate="company" placeholder="Ex : Société ABC SARL" required value="${prospect.raisonSociale}">
                    </div>

                    <div class="form-group mb-3">
                        <label for="nom" class="form-label">Nom *</label>
                        <div class="input-group">
                            <input type="text" class="form-control" id="nom" name="nom" value="${prospect.nom}" required pattern="^[A-Za-zÀ-ÖØ-öø-ÿ' -]{2,40}$" title="Lettres, espaces, tirets, apostrophes uniquement" data-validate="name">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="prenom" name="prenom" value="${prospect.prenom}" required pattern="^[A-Za-zÀ-ÖØ-öø-ÿ' -]{2,40}$" title="Lettres, espaces, tirets, apostrophes uniquement" data-validate="name">
                            <span class="input-group-text" data-bs-toggle="tooltip" data-bs-placement="top" 
                ...
                <div class="col-12">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="date" class="form-control" id="dateProspection" name="dateProspection" 
                               data-validate="date" required value="${prospect.dateProspection}">
                    </div>

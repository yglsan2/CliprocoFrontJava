    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1><i class="fas fa-edit"></i> Modification du client</h1>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" id="codePostal" name="codePostal" class="form-control"
                               ...
                               required value="${client.adresse.codePostal}">
                        <div class="invalid-feedback">
                ...
                <div class="col-12">
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control" id="chiffreAffaires" name="chiffreAffaires" 
                               step="0.01" min="0" required value="${client.chiffreAffaires}">
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control" id="nbEmployes" name="nbEmployes" 
                               min="1" required value="${client.nbEmployes}">
                    </div>

                    <div class="form-group mb-3">
                        <label for="commentaires" class="form-label">Commentaires</label>
                        <textarea class="form-control" id="commentaires" name="commentaires" 
                                  rows="3">${client.commentaires}</textarea>
                    </div>
                </div>
            </div>
